          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!_this.user.name) {
                  _this.errors.name = ['Name is required'];
                  _this.isError = true;
                } else {
                  _this.errors.name = '';
                }
                ...
                if (!_this.user.password_confirmation) {
                  _this.errors.password_confirmation = ['Password confirmation is required'];
                  _this.isError = true;
                } else if (_this.user.password_confirmation != _this.user.password) {
                  _this.errors.password_confirmation = ['Password confirmation did\'t match.'];
                  _this.isError = true;
                } else {
              ...
              case 13:
                _this.processing = true;
                _context.next = 16;
                return axios.post('/api/register', _this.user).then(function (_ref) {
                  var data = _ref.data;
